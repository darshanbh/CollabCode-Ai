...
function Navbar() {
  ...
  const scrollToSection = (id) => {
    if (location.pathname !== '/') {
      navigate('/#' + id);
      // After navigation, the LandingPage will need to handle the scroll if it's a fresh mount
      return;
    }
  ...
  return (
    <nav style={styles.navbar}>
      ...
      <div style={styles.links}>
        <span style={styles.link} onClick={() => scrollToSection('home')}>Home</span>
        <span style={styles.link} onClick={() => scrollToSection('features')}>Features</span>
